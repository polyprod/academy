// Example program #1 from Chapter 22 of Absolute Beginner's Guide to
// C, 3rd Edition
// File Chapter22ex1.c

/* This program takes an ID number from the user and then checks
the ID against a list of customers in the database. If the 
customer exists, it uses that array element to check their current
...
int main()
{
    ...
    // Defines the 10 elements in the two parallell arrays

    int custID[10] = {313, 453, 502, 101, 892, 475, 792, 912,
                        343, 633};
