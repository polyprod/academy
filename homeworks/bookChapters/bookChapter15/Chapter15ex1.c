// Example program #1 from Chapter 15 of Absolute Beginner's Guide to
// C, 3rd Edition
// File Chapter15ex1.c
...
rating from 1 to 10. It will remember their favorite movie and 
their least favorite movie. */
