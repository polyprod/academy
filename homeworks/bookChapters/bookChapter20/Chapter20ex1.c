// Example program #1 from Chapter 20 of Absolute Beginner's Guide to
// C, 3rd Edition
// File Chapter20ex1.c

/* This program demonstrates the math functions from the C 
math.h library, so that you can get your homework right
